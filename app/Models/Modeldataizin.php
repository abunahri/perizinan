...
class Modeldataizin extends Model
{
    protected $table = "izin";
    protected $column_order = array(null, 'izin_nomor','nama','nama_kelas','izin_tgl','izin_tglkembali','izin_keperluan','telp','izin_status', null);
