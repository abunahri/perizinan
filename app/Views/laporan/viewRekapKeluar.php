...
if ($tampildata->getNumRows() >0) { ?>
	<div class="card">
		<div class="card-header">
			Rekap Perizinan Keluar
			<div class="card-tools">
				<button type="button" class="btn btn-tool btn-primary" id="cetakSemuarekapKeluar" title="Print Data">
...
<script>
	$(document).ready(function(){
		$('#cetakSemuarekapKeluar').click(function(e){
			let kelas = $('#kelas').val();
			let kamar = $('#kamar').val();
			...
			if (kelas.length == 0) {
				...
				let windowCetak = window.open('/laporan/cetakrekapkeluar/'+kelas+'/'+kamar+'/'+priode,"Cetak Rekap Perizinan Keluar");
				windowCetak.focus();
			}
