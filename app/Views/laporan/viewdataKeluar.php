...
<?= $this->section('judul') ?>
<h3><i class="fa fa-fw fa-table"></i> Rekap Perizinan Keluar</h3>
<?= $this->endSection() ?>
...
<div class="row">
	<div class="col-md-12 tampilrekapKeluar">

	</div>
</div>
<script>
	function tampilRekapKeluar(){
		let kelas = $('#kelas').val();
		let kamar = $('#kamar').val();
		...
		$.ajax({
			...
			dataType: "json",
			beforeSend: function(){
				$('.tampilrekapKeluar').html('<i class="fa fa-spin fa-spinner"></i>')
			},
			success: function(response){
				$('.tampilrekapKeluar').html(response.data);
