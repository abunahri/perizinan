...
<head>
	...
	<title>Cetak Perizinan Pulang</title>
	...
	<table style="text-align:center; width: 100%;">
		<tr>
			<td colspan="9">
				...
				<h3 style="font-family: arial;">DATA PERIZINAN PULANG</h3>
	...
	<table class="table table-hover table-sm table-bordered" style="width:100%">
		<thead>
			<tr>
				...
				<th colspan="2" style="text-align:center;vertical-align:middle">Waktu Izin</th>
			...
			<tr>
				...
				<th style="text-align:center;vertical-align:middle">Tgl Kembali</th>
			</tr>
		</thead>
		<tbody>
			<?php
			...
			foreach($tampildata->getResultArray() as $row) :
				...
				<tr>
					...
					<td><?= $row['izin_tgl'] ?></td>
					<td><?= $row['izin_tglkembali'] ?></td>
					<td><?= $row['izin_keperluan'] ?></td>
					<td><?= $row['telp'] ?></td>
					<td>
						<?php 
						if ($today > $telat) {
							echo 'Telat '.$lama->days. ' Hari';
						}else{
