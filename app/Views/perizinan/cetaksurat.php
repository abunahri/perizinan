...
<head>
	...
	<title>Cetak Surat Jalan pulang</title>
	<link rel="stylesheet" href="<?= base_url() ?>/plugins/fontawesome-free/css/all.min.css">
	<!-- Theme style -->
	<link rel="stylesheet" href="<?= base_url() ?>/dist/css/adminlte.min.css">
</head>
<body onload="window.print();">
	<table style="width: 100%; border: 1px solid #000; line-height: 1.5; padding: 20px;">
		<thead>
			<tr>
		...
		<tbody>
			<tr>
				<td colspan="5" style="text-align: center;">
					<h5 style="font-family: arial; font-size: 14px; margin-top: -30px;"><u>Surat Perizinan Pulang</u></h5>
			...
			<tr>
				<?php
				if ($jenkel == 'Laki-laki') {
					echo '<td colspan="5">Dengan ini kami pengurus Pondok Modern Al-aqsha memberikan izin,<br> kepada santriwan:</td>';
				}else{
					echo '<td colspan="5">Dengan ini kami pengurus Pondok Modern Al-aqsha memberikan izin,<br> kepada santriwati:</td>';
				}
				?>
			...
			<tr>
				<td>Tangga Kembali</td>
				<td>:</td>
				<td colspan="3"><?= $tgl_kembali ?></td>
			</tr>
			<tr>
				<td>Keperluan</td>
				<td>:</td>
			...
			<tr>
				<td colspan="5">Demikian surat ijin ini kami berikan untuk di gunakan seperlunya.<br>terima kasih<br></td>
			</tr>
			<tr>
